...
(function(exports){
    ...
    exports.parser = function(string, sheet){
        /**
         * Mother Class
         */
            ...
            if( ! this.blocks)
            {
                ...
                for(var i=0; i<max; i++)
                {
                    ...
                    else if(c == '(')
                    {
                        ...
                        this.addBlock(new Parser(this.string.slice(i+1, p-1), this.sheet));
                        i = p-1;
                        //Reset block
                        block = '';
                    }
        ...
        return new Parser(string, sheet);
    }
